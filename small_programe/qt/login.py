...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(170, 80, 541, 141))
        ...
        self.password = QtWidgets.QTextEdit(self.verticalLayoutWidget)
        ...
        self.submit.setGeometry(QtCore.QRect(510, 250, 191, 71))
        font = QtGui.QFont()
        font.setPointSize(36)
        self.submit.setFont(font)
        self.submit.setObjectName("submit")
        self.display = QtWidgets.QTextBrowser(self.centralwidget)
        self.display.setGeometry(QtCore.QRect(70, 390, 511, 61))
